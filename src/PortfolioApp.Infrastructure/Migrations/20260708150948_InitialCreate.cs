        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AwardUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IssuedByLogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstitutionLogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HeroVideoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CtaPrimaryText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CtaPrimaryUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CtaSecondaryText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CtaSecondaryUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TypewriterTexts = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BackgroundType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BackgroundValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShowParticles = table.Column<bool>(type: "bit", nullable: false),
                    ShowScrollIndicator = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientLinkedIn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false),
                    ProjectWorkedOn = table.Column<string>(type: "nvarchar(max)", nullable: false),
